import { Bell, HeartHandshake, Shield, ZapIcon } from "lucide-react"

const features = [
    {
        title: "One Step Setup",
        description: "Just add one URL, and you're all set. No complex configurations, just quick and easy setup.",
        icon: <ZapIcon className="h-6 w-6" />
    },
    {
        title: "Flexible Notifications",
        description: "Get notified via Gmail or Discord – your choice. Add a Discord webhook link for Discord notifications, or we'll notify you via Gmail automatically.",
        icon: <Bell className="h-6 w-6" />
    },
    {
        title: "Automatic Health Checks",
        description: "We ping your server or app every 10 minutes to ensure it’s up and running with a 200 OK response.",
        icon: <HeartHandshake className="h-6 w-6" />
    },
    {
        title: "Reliability Monitoring",
        description: "Stay confident in your app’s uptime with real-time alerts and monitoring for maximum reliability.",
